...
RETRIEVAL_TOP_K = 10 # number of chunks to be retrieved
RERANKING_CHUNK_COUNT = 3

SOURCE_FILES_PATHS = ""
SOURCE_DIRECTORY = r"D:\GenAI\RAG\data\POV Dataset"
QUESTIONS_SOURCE = r'D:\GenAI\RAG\data\Benchmark_ExistingPOV_Horizon.xlsx'
OUTPUT_FILE = r"D:\GenAI\RAG\result\rag_results_horizon_reranking_base_query_q_t0_cs1000_jb.json"
...
def rerank_contexts(contexts: List[Dict], query: str, rerank_k: int = RERANKING_CHUNK_COUNT) -> List[Dict]:
...
def process_query(vector_store, query: str, k: int = 10) -> Dict:
    ...
    print("Initial Retrieved Contexts:")  # Debugging print
    for c in contexts_and_scores:
        print(c['content'][:50])
    reranked_contexts = rerank_contexts(contexts_and_scores, query, rerank_k=RERANKING_CHUNK_COUNT) # Rerank here
